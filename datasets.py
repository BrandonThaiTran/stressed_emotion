...
def get_loaders_temporal_dataset(dataset_file_path, file_name_list, loader_type, batch_size = 8, worker_num = 4):
...
def get_dataloader(dataset_file_path, loader_type):
    ...
    dataloader = get_loaders_temporal_dataset(dataset_file_path,
                                                        file_name_list,
                                                        loader_type)
