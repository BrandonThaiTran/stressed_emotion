...
def main():
	...
	# Modality
	parser.add_argument('--acoustic_modality', type=bool, default=False)
	...
	parser.add_argument('--rnn_layer_num_v', type=int, default=2, help='2 or 3')
...
def test(test_loader, model, criterion, device, opt):
	...
	with torch.no_grad():
		...
		for i, test_data in enumerate(test_loader):
			visual_features, _, acoustic_features, _, lexical_features, _, _, a_labels, _, _ = test_data
